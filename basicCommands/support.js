...
module.exports = {
    ...
    execute(message, args) {
      ...
      const githubLink = "https://github.com/razor23gtk";
      const replitLink = "https://discord.gg/QGMKQd9NJW";
      const youtubeLink = "https://www.youtube.com/@Apollo_belvedere";
        const embed = new EmbedBuilder()
            ...
            .setAuthor({
              ...
              url: 'https://discord.gg/aJTv9Wf5'
          })
            .setDescription(`➡️ **Join our Discord server for support and updates:**\n- Discord - ${supportServerLink}\n\n➡️ **Follow us on:**\n- GitHub - ${githubLink}\n- Replit - ${replitLink}\n- YouTube - ${youtubeLink}`)
            .setImage('https://files.shapes.inc/4586febf.png')
            .setTimestamp();
